...
public class CreatePlane : ScriptableWizard
{
	...
	void OnWizardCreate ()
	{
		if( !Directory.Exists("Assets/Custom Assets/") )
			AssetDatabase.CreateFolder("Assets", "Custom Assets");
		if( !Directory.Exists("Assets/Custom Assets/Meshes/") )
		AssetDatabase.CreateFolder("Assets/Custom Assets", "Meshes");
		...
		Mesh m = (Mesh)AssetDatabase.LoadAssetAtPath ("Assets/Custom Assets/Meshes/" + planeAssetName, typeof(Mesh));
		...
		if (m == null) {
			...
			AssetDatabase.CreateAsset(m, "Assets/Custom Assets/Meshes/" + planeAssetName);
